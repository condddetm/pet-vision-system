"""
分类评估脚本（纯 PyTorch）
输出到 backend/artifacts/classification:
- metrics.json
...
def parse_args():
    ...
    p.add_argument("--ckpt", type=str, default="backend/weights/cls_torch.pth")
    p.add_argument("--out_dir", type=str, default="backend/artifacts/classification")
...
def main():
    ...
    # confusion_matrix.json 供前端 API 读取
    cm_json = {
